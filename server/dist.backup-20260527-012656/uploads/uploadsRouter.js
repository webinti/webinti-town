...
import { detectMimeFromBytes, sanitizeSvg, isAllowedMime } from './validateUpload.js';
...
uploadsRouter.post('/:roomSlug', upload.single('file'), async (req, res) => {
...
uploadsRouter.get('/:roomSlug/:filename', (req, res) => {
    const { roomSlug, filename } = req.params;
...
//# sourceMappingURL=uploadsRouter.js.map